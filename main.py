import time
from search.algorithms import Dijkstra, State, AStar
...
# implementation of A* with hueristic value of 2 was added, and the graph were plotted, and has been removed from the code
# graph is still available in the root folder and the answers pdf
def main():
    """
